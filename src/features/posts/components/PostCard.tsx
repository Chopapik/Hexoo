  ...
  return (
    <>
      ...
      <div
        ...
        className="inline-flex w-full max-w-4xl cursor-pointer flex-col items-start justify-start gap-4 rounded-xl border-t-2 border-surface-card-border-default bg-surface-card-background-default p-3"
      >
        <PostMeta post={post} />
