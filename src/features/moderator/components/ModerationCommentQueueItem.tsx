  ...
  return (
    <div className="relative group animate-in fade-in slide-in-from-bottom-4 duration-300">
      ...
      <div className="border-2 border-surface-card-background-default rounded-xl overflow-hidden relative ">
        <p className="border-b border-fuchsia-500/10 bg-fuchsia-950/20 px-3 py-2 text-[10px] font-bold uppercase tracking-widest text-accent-fuchsia-background-hover/90 font-sans">
          {t("moderation.queue.thread")}
        </p>

        <div className="grid grid-cols-[28px_1fr] border-b border-divider-default bg-surface-card-background-default">
          <TreePostGutter />
        ...
        <div className="grid grid-cols-[36px_1fr]">
          <TreeCommentGutter />
          <div className="flex-1 min-w-0 flex flex-col border-l border-fuchsia-500/20 bg-surface-card-background-default">
            <div className=" p-5 border-b border-divider-default ">
              <p className="text-xs uppercase tracking-widest text-accent-fuchsia-background-hover/95 mb-3 font-bold font-sans">
